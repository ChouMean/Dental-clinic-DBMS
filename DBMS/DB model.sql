...
ALTER TABLE TAIKHOAN DROP CONSTRAINT FK_TK_VT
ALTER TABLE QUANTRIVIEN DROP CONSTRAINT FK_QTV_TK
ALTER TABLE NHASI DROP CONSTRAINT FK_NS_TK
ALTER TABLE NHANVIEN DROP CONSTRAINT FK_NV_TK
ALTER TABLE KHACHHANG DROP CONSTRAINT FK_KH_TK
ALTER TABLE LICHSUKHAM
DROP
	CONSTRAINT FK_LSK_KH,
	CONSTRAINT FK_LSK_NS
ALTER TABLE DICHVUSD
DROP
	CONSTRAINT PK_DVSD,
...
DROP
	CONSTRAINT FK_LH_KH,
	CONSTRAINT FK_LH_NS
ALTER TABLE LICHLAMVIEC DROP CONSTRAINT FK_LR_NS
...
EXEC sp_droptype 'XSTEXT'
EXEC sp_droptype 'STEXT'
EXEC sp_droptype 'MTEXT'
EXEC sp_droptype 'LTEXT'
...
CREATE TABLE THUOC (
	...
	DONVITINH XSTEXT,
	CHIDINH STEXT,
	NGAYHETHAN DATE NOT NULL CHECK (NGAYHETHAN > GETDATE()),
	SLKHO INT NOT NULL,
